...
public class GameA_Activity extends AppCompatActivity {
    ...
    private static final String ADMOB_AD_UNIT_ID = "ca-app-pub-5646098133984483/4932486961";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GameA_Activity.this, SaveActivity.class);
    ...
    private void refreshAd() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                refresh.setEnabled(true);
                Toast.makeText(GameA_Activity.this, "Failed to load native ad: "
